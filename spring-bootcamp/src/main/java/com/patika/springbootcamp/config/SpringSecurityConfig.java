package com.patika.springbootcamp.config;

import com.patika.springbootcamp.security.JwtFilter;
import com.patika.springbootcamp.service.CustomUserDetailsService;
...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                .authorizeRequests().antMatchers("/login", "/welcome","/swagger-ui/**", "/openapi/**", "/v3/**").permitAll()
